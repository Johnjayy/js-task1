function check1(){
    ...
    if (q1 == true ){
        ...
        document.getElementById("qst1").style.color="red";
...
function check2(){
    ...
    if(q2 == true){
        ...
        document.getElementById("qst2").style.color ="red";
    }
...
function check3(){
    ...
    if (q3== true ){
        ...
        document.getElementById("qst3").style.color="red";
...
function check4(){
    ...
    if (q4 == true ){
        ...
        document.getElementById("qst4").style.color="red";
...
function check5(){
    ...
    if (q5 == true ){
        ...
        document.getElementById("qst5").style.color="red";
